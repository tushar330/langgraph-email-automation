...
loader = TextLoader(os.path.join(base_dir, "data", "agency.txt"))
docs = loader.load()
...
vectorstore = Chroma.from_documents(doc_chunks, embeddings, persist_directory=os.path.join(base_dir, "db"))
